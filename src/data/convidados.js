module.exports = [
  ...
  },
  {
    ...
    resumo:
      "É livre docente (Professora Associada II, MS5.2) do Departamento de Filosofia do IFCH da Universidade Estadual de Campinas, UNICAMP, onde desenvolve pesquisas desde 1987 nas áreas de história da filosofia e história da filosofia da natureza. Graduou-se em Física pela USP, em 1980. Defendeu, em 1987, no IFCH-UNICAMP, o seu mestrado em filosofia sobre a Revolução Copernicano-Galileana: Origem, significado e inserção na história do pensamento científico e filosófico antigo e medieval. Doutorou-se em filosofia pela FFLCH-USP, em 1996, com tese sobre A evolução do conceito de inércia: de Filopono a Galileo. Em 2011, prestou concurso para Livre Docente na UNICAMP e foi aprovada, tornando-se Professora Associada I (MS5.1). Em 2015, submeteu-se ao Processo de Promoção por Mérito da carreira do magistério superior e, em 12/2015, foi promovida para o nível de Professor Associado II (MS-5.2). Fez estágio de pesquisa na Princeton University-EUA, a convite do Prof Dr. Daniel Garber, em 2014.e no Centre de Recherche sur la Pensée Antique “Bibliothèque Léon Robin” (Université de Paris IV et CNRS), em 2004 e 2008. De junho a agosto de 2016, esteve como Visiting Scholar in the Department of Philosophy of Princeton University - EUA, with Prof. Daniel Garber. Foi editora, de 1993 a 2013, dos Cadernos de História e Filosofia da Ciência, e, desde 2006, é diretora associada da coleção de livros Philosophia/Analytica, publicada pela Discurso Editorial. Foi bolsista de produtividade de pesquisa do CNPq, nível 1B, com o projeto “A recepção latina do conceito de matéria de Filopono no início da Filosofia Moderna? Desde março de 2022, é bolsista de produtividade de pesquisa do CNPq, com o projeto “A recepção latina da controvérsia entre Filopono e Simplicio acerca da relação entre natureza e movimento nos corpos elementares”. Tem publicado livros e artigos nas áreas de história da filosofia e história da filosofia da natureza, com ênfase principalmente nos seguintes temas: Aristóteles, Filopono de Alexandria, história da filosofia antiga e medieval, história da física e da astronomia.",
  },
  {
